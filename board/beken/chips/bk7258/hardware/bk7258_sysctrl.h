...
#define BK7258_AON_RTC_COUNTER    0x4400020cu
#define BK7258_CPU_RUN_STATUS     (BK7258_SYSCTRL_BASE + 0x0cu)
#define BK7258_CPU2_CONTROL       (BK7258_SYSCTRL_BASE + 0x18u)
#define BK7258_CPU1_IRQ_EN0       (BK7258_SYSCTRL_BASE + 0x88u)
#define BK7258_CPU1_IRQ_EN1       (BK7258_SYSCTRL_BASE + 0x8cu)
#define BK7258_CPU2_IRQ_EN0       (BK7258_SYSCTRL_BASE + 0x90u)
#define BK7258_CPU2_IRQ_EN1       (BK7258_SYSCTRL_BASE + 0x94u)
#define BK7258_GPIO_FUNC0         (BK7258_SYSCTRL_BASE + 0xc0u)

#define BK7258_CPU_STATUS_CPU2_RESET       (1u << 6)
#define BK7258_CPU_STATUS_CPU2_POWER_DOWN  (1u << 10)

#define BK7258_CPU2_RESET_RELEASE          (1u << 0)
#define BK7258_CPU2_POWER_DOWN              (1u << 1)
#define BK7258_CPU2_RXEVT_SEL               (1u << 5)
#define BK7258_CPU2_OFFSET_SHIFT            8
#define BK7258_CPU2_OFFSET_MASK             (0x00ffffffu << 8)
