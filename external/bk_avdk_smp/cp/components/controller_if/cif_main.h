...
enum BK_CMD_TYPE
{
    ...
    BK_CMD_OPENVELA_SCAN_PAGE  = 0x20D,
    BK_CMD_OPENVELA_COUNTRY_GET = 0x20E,
    BK_CMD_OPENVELA_COUNTRY_SET = 0x20F,
    BK_CMD_OPENVELA_AP_START    = 0x210,
    BK_CMD_OPENVELA_AP_STOP     = 0x211,
    BK_CMD_OPENVELA_AP_STATUS   = 0x212,
